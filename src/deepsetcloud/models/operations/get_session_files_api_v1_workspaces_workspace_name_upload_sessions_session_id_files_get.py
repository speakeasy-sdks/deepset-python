...
from ..shared import paginatedsessionfile as shared_paginatedsessionfile
...
class GetSessionFilesAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDFilesGetIngestionStatusFileIngestionStatusEnumEnum(str, Enum):
    r"""An enumeration."""
    PENDING = 'PENDING'
    FAILED = 'FAILED'
    FINISHED = 'FINISHED'
...
class GetSessionFilesAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDFilesGetRequest:
    ...
    ingestion_status: Optional[GetSessionFilesAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDFilesGetIngestionStatusFileIngestionStatusEnumEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ingestion_status', 'style': 'form', 'explode': True }})
...
class GetSessionFilesAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDFilesGetResponse:
    ...
    r"""Validation Error"""
    paginated_session_file: Optional[shared_paginatedsessionfile.PaginatedSessionFile] = dataclasses.field(default=None)
