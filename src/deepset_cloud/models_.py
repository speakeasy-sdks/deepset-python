...
class Models:
    ...
    def list(self, author: Optional[str] = None, node_type: Optional[str] = None) -> operations.ListModelAPIV1ModelGetResponse:
        ...
        query_params = { **utils.get_query_params(operations.ListModelAPIV1ModelGetRequest, request), **query_params }
        ...
        res = operations.ListModelAPIV1ModelGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
