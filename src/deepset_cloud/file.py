...
class File:
    ...
    def delete_multi(self, security: operations.DeleteFilesAPIV1WorkspacesWorkspaceNameFilesDeleteSecurity, workspace_name: str, request_body: Optional[operations.DeleteFilesAPIV1WorkspacesWorkspaceNameFilesDeleteFileNames] = None) -> operations.DeleteFilesAPIV1WorkspacesWorkspaceNameFilesDeleteResponse:
        r"""Delete Files
    ...
    def delete_single(self, security: operations.DeleteFileAPIV1WorkspacesWorkspaceNameFilesFileIDDeleteSecurity, file_id: str, workspace_name: str) -> operations.DeleteFileAPIV1WorkspacesWorkspaceNameFilesFileIDDeleteResponse:
        r"""Delete File
    ...
    def get(self, security: operations.GetFileAPIV1WorkspacesWorkspaceNameFilesFileIDGetSecurity, file_id: str, workspace_name: str) -> operations.GetFileAPIV1WorkspacesWorkspaceNameFilesFileIDGetResponse:
        r"""Get File
    ...
    def get_document(self, security: operations.GetDocumentAPIV1WorkspacesWorkspaceNameFilesFileIDDocumentsGetSecurity, file_id: str, workspace_name: str) -> operations.GetDocumentAPIV1WorkspacesWorkspaceNameFilesFileIDDocumentsGetResponse:
        r"""Get Document
    ...
    def get_meta_data(self, security: operations.GetFileMetaAPIV1WorkspacesWorkspaceNameFilesFileIDMetaGetSecurity, file_id: str, workspace_name: str) -> operations.GetFileMetaAPIV1WorkspacesWorkspaceNameFilesFileIDMetaGetResponse:
        r"""Get File Meta
    ...
    def update_meta_data(self, security: operations.UpdateFileMetaAPIV1WorkspacesWorkspaceNameFilesFileIDMetaPutSecurity, request_body: operations.UpdateFileMetaAPIV1WorkspacesWorkspaceNameFilesFileIDMetaPutMeta, file_id: str, workspace_name: str) -> operations.UpdateFileMetaAPIV1WorkspacesWorkspaceNameFilesFileIDMetaPutResponse:
        r"""Update File Meta
