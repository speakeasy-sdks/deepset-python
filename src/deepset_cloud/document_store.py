...
class DocumentStore:
    ...
    def count_documents(self, count_documents_params: shared.CountDocumentsParams, index_name: str, workspace_name: str) -> operations.CountDocumentsStreamAPIV1WorkspacesWorkspaceNameIndexesIndexNameDocumentsCountPostResponse:
    ...
    def list_document_streams(self, fetch_documents_params: shared.FetchDocumentsParams, index_name: str, workspace_name: str) -> operations.GetAllDocumentsStreamAPIV1WorkspacesWorkspaceNameIndexesIndexNameDocumentsStreamPostResponse:
    ...
    def search(self, query_documents_params: shared.QueryDocumentsParams, index_name: str, workspace_name: str) -> operations.QueryDocumentsStreamAPIV1WorkspacesWorkspaceNameIndexesIndexNameDocumentsQueryPostResponse:
