...
class Pipeline:
    ...
    def add_feedback(self, security: operations.AddFeedbackAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameFeedbackPostSecurity, post_pipeline_feedback: shared.PostPipelineFeedback, pipeline_name: str, workspace_name: str) -> operations.AddFeedbackAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameFeedbackPostResponse:
        r"""Add Feedback
    ...
    def create(self, security: operations.CreatePipelineAPIV1WorkspacesWorkspaceNamePipelinesPostSecurity, workspace_name: str, dry_run: Optional[bool] = None) -> operations.CreatePipelineAPIV1WorkspacesWorkspaceNamePipelinesPostResponse:
        r"""Create Pipeline
    ...
    def delete(self, security: operations.DeletePipelineAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameDeleteSecurity, pipeline_name: str, workspace_name: str) -> operations.DeletePipelineAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameDeleteResponse:
        r"""Delete Pipeline
    ...
    def deploy(self, security: operations.DeployPipelineAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameDeployPostSecurity, pipeline_name: str, workspace_name: str) -> operations.DeployPipelineAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameDeployPostResponse:
        r"""Deploy Pipeline
    ...
    def get(self, security: operations.GetPipelineAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameGetSecurity, pipeline_name: str, workspace_name: str) -> operations.GetPipelineAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameGetResponse:
        r"""Get Pipeline
        Returns a pipeline.
        """
    ...
    def get_files(self, security: operations.GetPipelineFilesAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameFilesGetSecurity, pipeline_name: str, workspace_name: str, status: Optional[operations.GetPipelineFilesAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameFilesGetStatusFileIndexingStatusQuery] = None) -> operations.GetPipelineFilesAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameFilesGetResponse:
    ...
    def get_indexing(self, security: operations.GetPipelineIndexingAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameIndexingGetSecurity, pipeline_name: str, workspace_name: str) -> operations.GetPipelineIndexingAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameIndexingGetResponse:
    ...
    def get_json(self, security: operations.GetPipelineYamlAsJSONAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameJSONGetSecurity, pipeline_name: str, workspace_name: str) -> operations.GetPipelineYamlAsJSONAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameJSONGetResponse:
    ...
    def get_metadata(self, security: operations.GetPipelineIndexMetadataAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameMetaGetSecurity, pipeline_name: str, workspace_name: str) -> operations.GetPipelineIndexMetadataAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameMetaGetResponse:
    ...
    def get_min_max_aggregation_metadata(self, security: operations.GetPipelineMinMaxAggregationMetadataAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameMetaMetaFieldAggregationGetSecurity, meta_field: str, pipeline_name: str, workspace_name: str) -> operations.GetPipelineMinMaxAggregationMetadataAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameMetaMetaFieldAggregationGetResponse:
    ...
    def get_stats(self, security: operations.GetPipelineStatsAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameStatsGetSecurity, pipeline_name: str, workspace_name: str) -> operations.GetPipelineStatsAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameStatsGetResponse:
    ...
    def get_yaml(self, security: operations.GetPipelineYamlAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameYamlGetSecurity, pipeline_name: str, workspace_name: str) -> operations.GetPipelineYamlAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameYamlGetResponse:
        r"""Get Pipeline Yaml
    ...
    def search(self, security: operations.SearchAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameSearchPostSecurity, pipeline_query: shared.PipelineQuery, pipeline_name: str, workspace_name: str) -> operations.SearchAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameSearchPostResponse:
        r"""Search
    ...
    def set_default(self, security: operations.SetDefaultPipelineAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameDefaultPostSecurity, pipeline_name: str, workspace_name: str) -> operations.SetDefaultPipelineAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameDefaultPostResponse:
    ...
    def undeploy(self, security: operations.UndeployPipelineAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameUndeployPostSecurity, pipeline_name: str, workspace_name: str) -> operations.UndeployPipelineAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameUndeployPostResponse:
        r"""Undeploy Pipeline
    ...
    def update_yaml(self, security: operations.UpdatePipelineYamlAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameYamlPutSecurity, pipeline_name: str, workspace_name: str) -> operations.UpdatePipelineYamlAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameYamlPutResponse:
