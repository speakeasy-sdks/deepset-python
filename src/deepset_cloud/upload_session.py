...
class UploadSession:
    ...
    def close(self, security: operations.CloseSessionAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDPutSecurity, close_session: shared.CloseSession, session_id: str, workspace_name: str) -> operations.CloseSessionAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDPutResponse:
        r"""Close Session
    ...
    def create(self, security: operations.CreateUploadSessionAPIV1WorkspacesWorkspaceNameUploadSessionsPostSecurity, create_session: shared.CreateSession, workspace_name: str) -> operations.CreateUploadSessionAPIV1WorkspacesWorkspaceNameUploadSessionsPostResponse:
    ...
    def get_status(self, security: operations.GetSessionStatusAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDGetSecurity, session_id: str, workspace_name: str) -> operations.GetSessionStatusAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDGetResponse:
