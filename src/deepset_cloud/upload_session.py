...
class UploadSession:
    ...
    def close(self, close_session: shared.CloseSession, session_id: str, workspace_name: str) -> operations.CloseSessionAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDPutResponse:
        r"""Close Session
    ...
    def create(self, create_session: shared.CreateSession, workspace_name: str) -> operations.CreateUploadSessionAPIV1WorkspacesWorkspaceNameUploadSessionsPostResponse:
