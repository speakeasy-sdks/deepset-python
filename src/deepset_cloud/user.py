...
class User:
    ...
    def delete(self, security: operations.DeleteUserAPIV1UsersUserIDDeleteSecurity, user_id: str) -> operations.DeleteUserAPIV1UsersUserIDDeleteResponse:
    ...
    def get(self, security: operations.GetUserAPIV1UsersUserIDGetSecurity, user_id: str) -> operations.GetUserAPIV1UsersUserIDGetResponse:
        r"""Get User [private]
    ...
    def update_permission(self, security: operations.UpdateUserPermissionAPIV1UsersUserIDPatchSecurity, request_body: operations.UpdateUserPermissionAPIV1UsersUserIDPatchUserRole, user_id: str) -> operations.UpdateUserPermissionAPIV1UsersUserIDPatchResponse:
