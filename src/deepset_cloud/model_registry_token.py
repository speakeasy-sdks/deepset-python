...
class ModelRegistryToken:
    ...
    def get(self, security: operations.GetTokenAPIV1ModelRegistryTokensProviderGetSecurity, provider: operations.GetTokenAPIV1ModelRegistryTokensProviderGetProviderModelProvider) -> operations.GetTokenAPIV1ModelRegistryTokensProviderGetResponse:
        r"""Get Token [private]
    ...
    def remove(self, security: operations.RemoveTokenAPIV1ModelRegistryTokensProviderDeleteSecurity, provider: operations.RemoveTokenAPIV1ModelRegistryTokensProviderDeleteProviderModelProvider) -> operations.RemoveTokenAPIV1ModelRegistryTokensProviderDeleteResponse:
    ...
    def save(self, security: operations.SaveTokenAPIV1ModelRegistryTokensProviderPostSecurity, create_model_registry_token: shared.CreateModelRegistryToken, provider: operations.SaveTokenAPIV1ModelRegistryTokensProviderPostProviderModelProvider) -> operations.SaveTokenAPIV1ModelRegistryTokensProviderPostResponse:
    ...
    def update(self, security: operations.UpdateTokenAPIV1ModelRegistryTokensProviderPutSecurity, update_model_registry_token: shared.UpdateModelRegistryToken, provider: operations.UpdateTokenAPIV1ModelRegistryTokensProviderPutProviderModelProvider) -> operations.UpdateTokenAPIV1ModelRegistryTokensProviderPutResponse:
