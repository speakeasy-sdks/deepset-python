...
class ModelRegistryToken:
    ...
    def get(self, provider: operations.GetTokenAPIV1ModelRegistryTokensProviderGetProviderModelProvider) -> operations.GetTokenAPIV1ModelRegistryTokensProviderGetResponse:
        r"""Get Token [private]
    ...
    def remove(self, provider: operations.RemoveTokenAPIV1ModelRegistryTokensProviderDeleteProviderModelProvider) -> operations.RemoveTokenAPIV1ModelRegistryTokensProviderDeleteResponse:
    ...
    def save(self, create_model_registry_token: shared.CreateModelRegistryToken, provider: operations.SaveTokenAPIV1ModelRegistryTokensProviderPostProviderModelProvider) -> operations.SaveTokenAPIV1ModelRegistryTokensProviderPostResponse:
    ...
    def save_token_deprecated(self, request: shared.CreateModelRegistryToken) -> operations.SaveTokenDeprecatedAPIV1ModelRegistryTokenPostResponse:
    ...
    def update(self, update_model_registry_token: shared.UpdateModelRegistryToken, provider: operations.UpdateTokenAPIV1ModelRegistryTokensProviderPutProviderModelProvider) -> operations.UpdateTokenAPIV1ModelRegistryTokensProviderPutResponse:
    ...
    def update_token_deprecated(self, request: shared.UpdateModelRegistryToken) -> operations.UpdateTokenDeprecatedAPIV1ModelRegistryTokenPutResponse:
