...
class Notebook:
    ...
    def create(self, security: operations.PostNotebookAPIV1NotebookPostSecurity, empty_class: Optional[shared.EmptyClass] = None, pipeline_id: Optional[str] = None) -> operations.PostNotebookAPIV1NotebookPostResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "empty_class", 'json')
