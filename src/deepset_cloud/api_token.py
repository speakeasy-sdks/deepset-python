...
class APIToken:
    ...
    def list(self, security: operations.ListTokensAPIV1TokenGetSecurity, after: Optional[str] = None, before: Optional[str] = None, limit: Optional[int] = None, page_number: Optional[int] = None) -> operations.ListTokensAPIV1TokenGetResponse:
    ...
    def remove(self, security: operations.RemoveTokenAPIV1TokenAPITokenIDDeleteSecurity, api_token_id: str) -> operations.RemoveTokenAPIV1TokenAPITokenIDDeleteResponse:
