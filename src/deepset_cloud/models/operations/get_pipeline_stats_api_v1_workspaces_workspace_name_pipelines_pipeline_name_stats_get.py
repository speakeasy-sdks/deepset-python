...
from ...models.components import pipelinestatistics as components_pipelinestatistics
...
class GetPipelineStatsAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameStatsGetResponse:
    ...
    pipeline_statistics: Optional[components_pipelinestatistics.PipelineStatistics] = dataclasses.field(default=None)
