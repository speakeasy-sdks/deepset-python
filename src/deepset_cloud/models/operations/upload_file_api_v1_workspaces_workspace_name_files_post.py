...
class UploadFileAPIV1WorkspacesWorkspaceNameFilesPostRequest:
    ...
    write_mode: Optional[UploadFileAPIV1WorkspacesWorkspaceNameFilesPostWriteModeFileWriteModeEnum] = dataclasses.field(default=UploadFileAPIV1WorkspacesWorkspaceNameFilesPostWriteModeFileWriteModeEnum.KEEP, metadata={'query_param': { 'field_name': 'write_mode', 'style': 'form', 'explode': True }})
