...
from ...models.components import evalpredictionsresponse as components_evalpredictionsresponse
...
class GetNodeEvalPredictionsAPIV1WorkspacesWorkspaceNameEvalRunsEvalRunNameNodesNodeNamePredictionsGetRequest:
    ...
    field: Optional[Field] = dataclasses.field(default=Field.INDEX, metadata={'query_param': { 'field_name': 'field', 'style': 'form', 'explode': True }})
    r"""The name of the entity you want to sort by."""
    ...
    order: Optional[Order] = dataclasses.field(default=Order.ASC, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    r"""Choose how you want to sort the results."""
...
class GetNodeEvalPredictionsAPIV1WorkspacesWorkspaceNameEvalRunsEvalRunNameNodesNodeNamePredictionsGetResponse:
    ...
    response_200_get_node_eval_predictions_api_v1_workspaces_workspace_name_eval_runs_eval_run_name_nodes_node_name_predictions_get: Optional[Union[components_evalpredictionsresponse.EvalPredictionsResponse, str]] = dataclasses.field(default=None)
    r"""These are the predicted answers for the node you chose. If you added 'text/csv' in the `accept` header, they're returned as a CSV file."""
