...
class GetSessionFilesAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDFilesGetRequest:
    ...
    ingestion_status: Optional[GetSessionFilesAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDFilesGetIngestionStatusFileIngestionStatusEnum] = dataclasses.field(default=GetSessionFilesAPIV1WorkspacesWorkspaceNameUploadSessionsSessionIDFilesGetIngestionStatusFileIngestionStatusEnum.FAILED, metadata={'query_param': { 'field_name': 'ingestion_status', 'style': 'form', 'explode': True }})
