...
from ...models.components import paginatedsharedprototypes as components_paginatedsharedprototypes
...
class ListPrototypesAPIV1WorkspacesWorkspaceNameSharedPrototypesGetResponse:
    ...
    paginated_shared_prototypes: Optional[components_paginatedsharedprototypes.PaginatedSharedPrototypes] = dataclasses.field(default=None)
