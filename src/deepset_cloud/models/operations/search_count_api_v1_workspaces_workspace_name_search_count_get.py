...
from ...models.components import searchcountpagination as components_searchcountpagination
...
class SearchCountAPIV1WorkspacesWorkspaceNameSearchCountGetResponse:
    ...
    search_count_pagination: Optional[components_searchcountpagination.SearchCountPagination] = dataclasses.field(default=None)
