...
from ..shared import pipelinemetadataaggregation as shared_pipelinemetadataaggregation
...
class GetPipelineMinMaxAggregationMetadataAPIV1WorkspacesWorkspaceNamePipelinesPipelineNameMetaMetaFieldAggregationGetResponse:
    ...
    r"""Validation Error"""
    pipeline_metadata_aggregation: Optional[shared_pipelinemetadataaggregation.PipelineMetadataAggregation] = dataclasses.field(default=None)
