...
from ...models.components import evalrunsresponse as components_evalrunsresponse
from enum import Enum
from typing import Optional

class QueryParamField(str, Enum):
...
class ListEvalRunsRequest:
    ...
    field: Optional[QueryParamField] = dataclasses.field(default=QueryParamField.CREATED_AT, metadata={'query_param': { 'field_name': 'field', 'style': 'form', 'explode': True }})
    r"""The name of the entity you want to sort by."""
