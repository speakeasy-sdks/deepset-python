...
from ..shared import filepagination as shared_filepagination
...
class ListFilesAPIV1WorkspacesWorkspaceNameFilesGetRequest:
    ...
    field: Optional[ListFilesAPIV1WorkspacesWorkspaceNameFilesGetFieldField] = dataclasses.field(default=ListFilesAPIV1WorkspacesWorkspaceNameFilesGetFieldField.CREATED_AT, metadata={'query_param': { 'field_name': 'field', 'style': 'form', 'explode': True }})
    r"""The name of the entity you want to sort by."""
    ...
    order: Optional[ListFilesAPIV1WorkspacesWorkspaceNameFilesGetOrderOrder] = dataclasses.field(default=ListFilesAPIV1WorkspacesWorkspaceNameFilesGetOrderOrder.ASC, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    r"""Choose how you want to sort the results."""
