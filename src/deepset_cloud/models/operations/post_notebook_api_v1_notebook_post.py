...
from ..shared import emptyclass as shared_emptyclass
...
class PostNotebookAPIV1NotebookPostRequest:
    empty_class: Optional[shared_emptyclass.EmptyClass] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
