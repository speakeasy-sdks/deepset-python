...
class PipelineStatistics:
    ...
    correct_answers: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('correct_answers'), 'exclude': lambda f: f is None }})
    r"""The number of answers marked as correct."""
    experiments_created: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('experiments_created'), 'exclude': lambda f: f is None }})
    r"""The total number of experiments created for this pipeline."""
    indexed_files: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('indexed_files'), 'exclude': lambda f: f is None }})
    ...
    manual_feedback_input: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('manual_feedback_input'), 'exclude': lambda f: f is None }})
    r"""The total number of manual feedback inputs provided by users for this pipeline."""
    total_documents: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('total_documents'), 'exclude': lambda f: f is None }})
    r"""The total number of documents created for this pipeline."""
    total_queries: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('total_queries'), 'exclude': lambda f: f is None }})
    r"""The total number of queries for this pipeline."""
    users_provided_feedback: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('users_provided_feedback'), 'exclude': lambda f: f is None }})
    r"""The total number of unique feedback messages the users provided for the results of this pipeline."""
    wrong_answers: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('wrong_answers'), 'exclude': lambda f: f is None }})
