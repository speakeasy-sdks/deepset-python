...
import dataclasses
from ..shared import organizationformatted as shared_organizationformatted
...
class User:
    ...
    organization: shared_organizationformatted.OrganizationFormatted = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('organization') }})
