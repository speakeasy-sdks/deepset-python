...
class DeepsetCloudAnswer:
    ...
    r"""Type of the answer."""
    context: Optional[Union[str, DeepsetCloudAnswerContextContext, list[Any]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('context'), 'exclude': lambda f: f is None }})
    r"""Context of the answer."""
