...
class LabelWithPredictionLabelStateAsStrEnum(str, Enum):
    r"""An enumeration."""
...
class LabelWithPrediction:
    ...
    state: LabelWithPredictionLabelStateAsStrEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
