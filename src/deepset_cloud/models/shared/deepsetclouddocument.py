...
class DeepsetCloudDocument:
    ...
    r"""The metadata of this document."""
    content: Optional[Union[str, DeepsetCloudDocumentContentContent, list[Any]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('content'), 'exclude': lambda f: f is None }})
    r"""Content of the document."""
