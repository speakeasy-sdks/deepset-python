...
from ..shared import answernodeevalrunmetric as shared_answernodeevalrunmetric
from ..shared import documentnodeevalrunmetric as shared_documentnodeevalrunmetric
...
@dataclasses.dataclass
class SingleEvalRunResponseEvalResults:
    pass
...
class SingleEvalRunResponse:
    ...
    logs: List[shared_logentry.LogEntry] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logs') }})
    ...
    eval_results: Optional[List[Union[shared_answernodeevalrunmetric.AnswerNodeEvalRunMetric, shared_documentnodeevalrunmetric.DocumentNodeEvalRunMetric]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eval_results'), 'exclude': lambda f: f is None }})
