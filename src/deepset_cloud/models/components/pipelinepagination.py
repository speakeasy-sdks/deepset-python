...
import dataclasses
from .pipelineindexing import PipelineIndexing
...
class PipelinePagination:
    data: List[PipelineIndexing] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
