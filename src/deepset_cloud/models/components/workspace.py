...
class Workspace:
    ...
    languages: Optional[WorkspaceLanguages] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('languages'), 'exclude': lambda f: f is None }})
    r"""Supported languages within a workspace."""
    metadata_fields: Optional[WorkspaceMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metadata_fields'), 'exclude': lambda f: f is None }})
    r"""Metadata for workspaces."""
