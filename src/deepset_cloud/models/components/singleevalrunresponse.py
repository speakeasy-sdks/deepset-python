...
from .answernodeevalrunmetric import AnswerNodeEvalRunMetric
from .documentnodeevalrunmetric import DocumentNodeEvalRunMetric
from .logentry import LogEntry
from .pipelinenodeconfig import PipelineNodeConfig
from .tag import Tag
...
class SingleEvalRunResponse:
    ...
    logs: List[LogEntry] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logs') }})
    ...
    eval_results: Optional[List[Union[AnswerNodeEvalRunMetric, DocumentNodeEvalRunMetric]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eval_results'), 'exclude': lambda f: f is None }})
