...
import dataclasses
from .evalrunresponse import EvalRunResponse
...
class EvalRunsResponse:
    data: List[EvalRunResponse] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
