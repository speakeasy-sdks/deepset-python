...
from .feedbacksearchresult import FeedbackSearchResult
from .tag import Tag
...
class PipelineFeedback:
    ...
    search_result: FeedbackSearchResult = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('search_result') }})
