...
class EvalRun:
    ...
    def create_eval_run(self, eval_run_post: shared.EvalRunPost, workspace_name: str) -> operations.CreateEvalRunAPIV1WorkspacesWorkspaceNameEvalRunsPostResponse:
        r"""Create Eval Run
    ...
    def get_node_eval_predictions(self, request: operations.GetNodeEvalPredictionsAPIV1WorkspacesWorkspaceNameEvalRunsEvalRunNameNodesNodeNamePredictionsGetRequest) -> operations.GetNodeEvalPredictionsAPIV1WorkspacesWorkspaceNameEvalRunsEvalRunNameNodesNodeNamePredictionsGetResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Union[shared.EvalPredictionsResponse, str]])
    ...
    def update(self, eval_run_patch: shared.EvalRunPatch, eval_run_name: str, workspace_name: str) -> operations.EditEvalRunAPIV1WorkspacesWorkspaceNameEvalRunsEvalRunNamePatchResponse:
        r"""Edit Eval Run
