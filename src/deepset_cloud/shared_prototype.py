...
class SharedPrototype:
    ...
    def create(self, security: operations.CreatePrototypeAPIV1WorkspacesWorkspaceNameSharedPrototypesPostSecurity, post_shared_prototype: shared.PostSharedPrototype, workspace_name: str) -> operations.CreatePrototypeAPIV1WorkspacesWorkspaceNameSharedPrototypesPostResponse:
    ...
    def create_external_user(self, security: operations.CreateExternalUserAPIV1WorkspacesWorkspaceNameSharedPrototypeUsersPostSecurity, workspace_name: str, existing_user_id: Optional[str] = None) -> operations.CreateExternalUserAPIV1WorkspacesWorkspaceNameSharedPrototypeUsersPostResponse:
    ...
    def get(self, security: operations.GetSharedPrototypeAPIV1WorkspacesWorkspaceNameSharedPrototypesSharedPrototypeIDGetSecurity, shared_prototype_id: str, workspace_name: str) -> operations.GetSharedPrototypeAPIV1WorkspacesWorkspaceNameSharedPrototypesSharedPrototypeIDGetResponse:
    ...
    def revoke(self, security: operations.RevokeSharedPrototypeAPIV1WorkspacesWorkspaceNameSharedPrototypesSharedPrototypeIDDeleteSecurity, shared_prototype_id: str, workspace_name: str) -> operations.RevokeSharedPrototypeAPIV1WorkspacesWorkspaceNameSharedPrototypesSharedPrototypeIDDeleteResponse:
    ...
    def update(self, security: operations.EditSharedPrototypeAPIV1WorkspacesWorkspaceNameSharedPrototypesSharedPrototypeIDPatchSecurity, patch_shared_prototype: shared.PatchSharedPrototype, shared_prototype_id: str, workspace_name: str) -> operations.EditSharedPrototypeAPIV1WorkspacesWorkspaceNameSharedPrototypesSharedPrototypeIDPatchResponse:
