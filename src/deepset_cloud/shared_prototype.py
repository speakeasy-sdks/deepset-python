...
class SharedPrototype:
    ...
    def update(self, request_body: dict[str, Any], shared_prototype_id: str, workspace_name: str) -> operations.EditSharedPrototypeAPIV1WorkspacesWorkspaceNameSharedPrototypesSharedPrototypeIDPatchResponse:
