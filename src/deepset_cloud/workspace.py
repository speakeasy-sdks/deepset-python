...
class Workspace:
    ...
    def get_stats(self, request: operations.GetWorkspaceStatsAPIV1WorkspacesWorkspaceNameStatsGetRequest, security: operations.GetWorkspaceStatsAPIV1WorkspacesWorkspaceNameStatsGetSecurity) -> operations.GetWorkspaceStatsAPIV1WorkspacesWorkspaceNameStatsGetResponse:
