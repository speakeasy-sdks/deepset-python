...
class Workspace:
    ...
    def delete(self, security: operations.DeleteWorkspaceAPIV1WorkspacesWorkspaceNameDeleteSecurity, workspace_name: str) -> operations.DeleteWorkspaceAPIV1WorkspacesWorkspaceNameDeleteResponse:
    ...
    def get(self, security: operations.GetWorkspaceAPIV1WorkspacesWorkspaceNameGetSecurity, workspace_name: str) -> operations.GetWorkspaceAPIV1WorkspacesWorkspaceNameGetResponse:
    ...
    def get_stats(self, security: operations.GetWorkspaceStatsAPIV1WorkspacesWorkspaceNameStatsGetSecurity, workspace_name: str) -> operations.GetWorkspaceStatsAPIV1WorkspacesWorkspaceNameStatsGetResponse:
