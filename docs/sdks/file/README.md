...
res = s.file.delete_multi(workspace_name='Funk', request_body=operations.DeleteFilesAPIV1WorkspacesWorkspaceNameFilesDeleteFileNames(
    names=[
        'Executive',
    ],
))
...
res = s.file.delete_single(file_id='b655849d-609b-4e06-9c6c-7a066adc84ee', workspace_name='Developer')
...
res = s.file.get(file_id='b18d8d81-fd7b-4764-a31e-475cb1f36591', workspace_name='Optional')
...
res = s.file.get_document(file_id='873d3623-7b2a-4a5d-9317-57cc835bc671', workspace_name='JBOD')
...
res = s.file.get_meta_data(file_id='ca54c4ff-7683-4387-b133-9ade3a8c3660', workspace_name='Colorado')
...
req = operations.ListFilesAPIV1WorkspacesWorkspaceNameFilesGetRequest(
    after_file_id='c184a429-302e-4aca-80db-f1718b882a50',
    after_value='backing',
    content='optimize itaque',
    field=operations.ListFilesAPIV1WorkspacesWorkspaceNameFilesGetFieldField.CREATED_AT,
    filter='Surprise tan',
    limit=168183,
    meta_key='Smart',
    meta_value='North',
    name='female candela bedrock',
...
res = s.file.update_meta_data(request_body=operations.UpdateFileMetaAPIV1WorkspacesWorkspaceNameFilesFileIDMetaPutMeta(), file_id='c21bf6a8-ed89-4437-a617-505b3da68dfd', workspace_name='Account')
...
res = s.file.upload(workspace_name='Market', body_upload_file_api_v1_workspaces_workspace_name_files_post=shared.BodyUploadFileAPIV1WorkspacesWorkspaceNameFilesPost(
    file=shared.BodyUploadFileAPIV1WorkspacesWorkspaceNameFilesPostFile(
        file='connect Market',
        content='n=VA69BM,X'.encode(),
    ),
    meta='West City',
    text='fuchsia male',
), file_name='F2M', write_mode=operations.UploadFileAPIV1WorkspacesWorkspaceNameFilesPostWriteModeFileWriteModeEnum.OVERWRITE)
