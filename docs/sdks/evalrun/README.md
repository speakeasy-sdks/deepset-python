...
res = s.eval_run.create_eval_run(eval_run_post=shared.EvalRunPost(
    ...
    debug=False,
    evaluation_set_name='Mountain',
    name='female Savings Virginia',
    pipeline_name='auxiliary Bicycle',
    tags=[
        'loftily',
    ],
), workspace_name='enhance')
...
req = operations.GetNodeEvalPredictionsAPIV1WorkspacesWorkspaceNameEvalRunsEvalRunNameNodesNodeNamePredictionsGetRequest(
    after='c1dba3f8-e9ed-41b3-a318-bba7f1cb4ef1',
    before='717b3317-ff46-4a62-9c7e-abdcd3cf0e87',
    eval_run_name='Concrete Magnesium Secured',
    field=operations.GetNodeEvalPredictionsAPIV1WorkspacesWorkspaceNameEvalRunsEvalRunNameNodesNodeNamePredictionsGetFieldField.F1_DOCUMENT_ID_AND_CONTEXT_SCOPE,
    filter='generate Transexual Transexual',
    limit=941873,
    node_name='Bicycle hacking',
    ...
    page_number=483047,
    select='Rest',
    workspace_name='National Southeast Salad',
)
...
res = s.eval_run.update(eval_run_patch=shared.EvalRunPatch(
    ...
    evaluation_set_name='Rock',
    pipeline_name='male Metal',
    tags=[
        'cheater',
    ],
), eval_run_name='Islands', workspace_name='online')
