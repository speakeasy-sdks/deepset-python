...
res = s.model_registry_token.get(provider=operations.GetTokenAPIV1ModelRegistryTokensProviderGetProviderModelProvider.COHERE)
...
res = s.model_registry_token.update(update_model_registry_token=shared.UpdateModelRegistryToken(
    token='Van',
), provider=operations.UpdateTokenAPIV1ModelRegistryTokensProviderPutProviderModelProvider.HUGGINGFACE)
