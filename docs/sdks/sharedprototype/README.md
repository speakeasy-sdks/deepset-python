...
res = s.shared_prototype.update(patch_shared_prototype=shared.PatchSharedPrototype(), shared_prototype_id='d0905bf4-aa77-4f20-8e77-54c352acfe54', workspace_name='string')
