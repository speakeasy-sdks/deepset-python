...
res = s.evaluation_set.delete(evaluation_set_name='saepe', workspace_name='suscipit')
...
res = s.evaluation_set.get(evaluation_set_name='deserunt', workspace_name='provident')
...
res = s.evaluation_set.get_csv(evaluation_set_name='minima', workspace_name='repellendus')
...
req = operations.ListEvaluationSetsAPIV1WorkspacesWorkspaceNameEvaluationSetsGetRequest(
    after='d446ce2a-f7a7-43cf-bbe4-53f870b326b5',
    before='a73429cd-b1a8-4422-bb67-9d2322715bf0',
    limit=765326,
    name='Robin Bosco',
    page_number=83422,
...
res = s.evaluation_set.retrigger(evaluation_set_name='quos', workspace_name='tempore')
